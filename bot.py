...
ANIMALS = {
    "Альпака": {
        "fact": "Шерсть альпак ценится за мягкость и способность отлично сохранять тепло. Из-за отсутствия ланолина она является полностью гипоаллергенной",
    ...
    "Лемур кошачий": {
        "fact": "Знаешь, кто такие кошачьи лемуры? Это пушистые приматы с Мадагаскара. Больше всего на свете они любят скакать по веткам. Один их прыжок в длину может быть целых 10 метров!",
    ...
    "Амурский тигр": {
        "fact": "Знаешь, кто самый крупный в тигриной семье? Это амурский тигр. Он такой огромный, что весит целых 300 килограммов — как пять взрослых мужчин вместе взятых",
    ...
    "Белогрудый еж": {
        "fact": "Белогрудый еж — настоящий ночной рыцарь в колючих доспехах. Днем его не сыщешь, зато ночью он смело бегает по лесу. От врагов ежик защищается хитро: сворачивается в плотный шар, выставляя наружу тысячи острых игл длиной до 3 сантиметров.",
